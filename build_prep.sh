...
pkgs="debootstrap binutils bridge-utils qemu-utils genisoimage ruby1.8 ruby1.8-dev rubygems1.8 kvm rpm rpm2cpio python-pip gcc make git-core curl ruby-libxml"
